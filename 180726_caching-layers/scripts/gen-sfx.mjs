...
const SFX = {
  emit: { f: 880, ms: 40, decay: 5, gain: 0.45 }, // read rời client
  bounce: { f: 620, ms: 70, decay: 7, gain: 0.4, sweep: -0.45 }, // bật khỏi cache
  arrive: { f: 523.25, ms: 60, decay: 4.5, gain: 0.34, harm: 0.3 }, // về tới client
  fill: { f: 1180, ms: 45, decay: 9, gain: 0.3, sub: 0.4 }, // cache được đổ đầy
  slow: { f: 120, ms: 150, decay: 2.4, gain: 0.5, sub: 0.5 }, // rơi tới DB — nặng, chậm
  fall: { f: 300, ms: 60, decay: 5, gain: 0.22, sweep: -0.6, noise: 0.2 }, // xuyên màng rách
}
