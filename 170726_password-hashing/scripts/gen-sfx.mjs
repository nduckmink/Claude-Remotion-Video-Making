...
const SFX = {
  emit: { f: 880, ms: 40, decay: 5, gain: 0.5 }, // bản ghi rời frontend
  arrive: { f: [523.25, 659.25, 783.99], ms: 60, decay: 4.5, gain: 0.34, harm: 0.3 }, // nằm xuống db
  attach: { f: 1180, ms: 45, decay: 9, gain: 0.3, sub: 0.53 }, // salt cắm vào
  absorb: { f: 180, ms: 70, decay: 5.5, gain: 0.42 }, // búa gõ — bị biến đổi
  install: { f: 90, ms: 250, decay: 2.2, gain: 0.4, sweep: 1, harm: 0.35 }, // bcrypt hiện ra
  fail: { f: 140, ms: 90, decay: 6, gain: 0.5, sub: 0.4 }, // database bị húc thủng
  drop: { f: 240, ms: 110, decay: 4, gain: 0.32, sweep: -0.5, sub: 0.3 }, // hash bị ném đi
};
