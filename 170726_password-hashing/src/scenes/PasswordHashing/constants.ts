// Password Hashing — hằng số scene.
//
// Ý DUY NHẤT của loop:
...
export const BCRYPT = { x: 440, y: 580, w: 200, h: 320 };
...
/** Chỗ nó trồi lên từ. Húc LÊN cho tới khi đỉnh nhọn chạm đáy database.
 *  Hiện dần trong 10 frame đầu — bụp ra giữa khung là một cú nháy, không phải
 *  một cú xuất hiện. */
export const HACKER_REST = { x: 850, y: 1480 };
export const HACKER_FADE = 10;
export const HACKER_HIT = { x: 850, y: DATABASE.y + DATABASE.h + HACKER_R }; // 1088
export const HACKER_RISE = frames(HACKER_REST, HACKER_HIT); // 43

/** Chỗ đồ ăn trộm bám theo hacker lúc nó rút lui. */
...
// Ném sang TRÁI, tránh cột x=850 mà hacker rơi xuống — nó không được giẫm lên
// đống nó vừa vứt.
export const TRASH = [
  { x: 300, y: 1452, rot: -13 },
  { x: 490, y: 1498, rot: 9 },
...
export const RESET = 856;
export const RESET_DUR = 24; // 856 + 24 = 880 = LOOP → f880 trùng khít f0
